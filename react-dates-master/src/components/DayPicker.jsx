...
class DayPicker extends React.PureComponent {
  ...
  renderBottomButton(onClick, bottomButtonText, twoElements){
    return (<div className={"bottom-button-container" + (twoElements ? " bottom-button-container--two-elements" : "")}>
      <button
          ...
          >
            ...
            >
              ...
              >
                ...
                {showConfirmButton && this.renderBottomButton(onOutsideClick, confirmButtonText)}
              </div>
