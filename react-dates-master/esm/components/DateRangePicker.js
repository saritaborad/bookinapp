...
var DateRangePicker = /*#__PURE__*/function (_ref) {
  ...
  _proto.renderDayPicker = function renderDayPicker() {
    ...
    }, css(styles.DateRangePicker_picker, showCloseButton && styles.DateRangePicker_picker__withCloseButton, showBottomButton && styles.DateRangePicker_picker__withBottomButton, anchorDirection === ANCHOR_LEFT && styles.DateRangePicker_picker__directionLeft, anchorDirection === ANCHOR_RIGHT && styles.DateRangePicker_picker__directionRight, orientation === HORIZONTAL_ORIENTATION && styles.DateRangePicker_picker__horizontal, orientation === VERTICAL_ORIENTATION && styles.DateRangePicker_picker__vertical, !withAnyPortal && openDirection === OPEN_DOWN && {
      top: inputHeight - 1
    ...
    }), showCloseButton && /*#__PURE__*/React.createElement("button", _extends({}, css(styles.DateRangePicker_closeButton), {
      type: "button",
